...
public class RecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        getIncomingIntentFromUp();
    }
    private void getIncomingIntentFromUp() {
        if (getIntent().hasExtra("titre")) {
             songs_folder = getIntent().getStringExtra("titre");
            System.out.println("song for " + songs_folder);
        }
    }
    ...
    public void gotoRecodingListActivity(View view) {
        Intent intent = new Intent(this, RecordingListActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra("folder",songs_folder);
